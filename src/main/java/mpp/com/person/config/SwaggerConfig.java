...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("mpp.com.person.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("Micro serviço de Person",
				"Micro serviço para controlar pessoas ",
				"Versão 1.0",
				"https://github.com/RuanNunes/",
